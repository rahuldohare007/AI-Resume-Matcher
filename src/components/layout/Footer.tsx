...
//               <li>
//                 <Link href="/upload" className="text-gray-300 hover:text-blue-400 transition-colors">
//                   Upload Resume
//                 </Link>
//               </li>
//               <li>
//                 <Link href="/jobs" className="text-gray-300 hover:text-blue-400 transition-colors">
//                   Job Descriptions
//                 </Link>
//               </li>
//               <li>
